function gravity() {
    ...
    (function() {
        ...
        function resize(e) {
            screenWidth  = canvas.width  = $("#gravity-demo-wrap").width();
            screenHeight = canvas.height = $("#gravity-demo-wrap").height();
        ...
        function mouseMove(e) {
            let offsetLeft = canvas.getBoundingClientRect().left + $(window).scrollLeft();
            let offsetTop = canvas.getBoundingClientRect().top + $(window).scrollTop();
        ...
        function mouseDown(e) {
            ...
            console.log(x, y, " ", e.clientX, e.clientY, " ", canvas.width, canvas.height);
            console.log(e.pageY, offsetTop, canvas.getBoundingClientRect().top, $(window).scrollTop());
